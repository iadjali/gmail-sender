...
[![CI](https://github.com/yourusername/gmail-sender/actions/workflows/ci.yml/badge.svg)](https://github.com/yourusername/gmail-sender/actions/workflows/ci.yml)
[![PyPI version](https://badge.fury.io/py/gmail-sender.svg)](https://pypi.org/project/gmail-sender/)
...
python -m venv .venv && . .venv/bin/activate
pip install -r requirements.txt
pip install ruff mypy pytest  # Development dependencies
```
...
Import `gmail_sender` in your Python application to send emails programmatically:
...
Send HTML emails with attachments and CC/BCC:
...
send_email(
    ...
    body="<h1>Monthly Report</h1><p>See attached files.</p>",
    html=True,
